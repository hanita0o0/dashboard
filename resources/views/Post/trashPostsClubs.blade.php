...
<button style="display: inline;" class="btn btn-info"><a href="{{Route('postsClubsDel')}}">حذف همه برای همیشه</a></button>
<button class="btn btn-info"><a href="{{route('PostsClubsRestore')}}">بازیابی همه </a></button><hr>
...
<table id="example" class="display " >
    ...
    @for($i=0 ; $i<count($posts); $i++)
        ...
        <tr>
            ...
            <td>
            <button  class="btn btn-danger" onclick="return confirm('آیا مطمئن هستید؟؟؟؟')"><a href="{{route('postClubDel',$posts[$i]['id'])}}">حذف برای همیشه </a></button>
            <button  class="btn btn-danger"><a href="{{Route('PostClubRestore',$posts[$i]['id'])}}">بازیابی</a></button>
    </tr>
    @endfor
    </tbody>
